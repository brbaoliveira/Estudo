...
class WorkSchedule(
    ...
    @Column(nullable = false)
    var name : String = "Padrão",

    @Column(nullable = false)
    var dailyMinutes : Int = 480,
    var startTime : LocalTime? = null,
    var endTime : LocalTime? = null
)

@Entity
@Table(name = "work_records", uniqueConstraints = [UniqueConstraint(columnNames = ["user_id", "date"])])
class WorkRecord(
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    var id : Long = 0,
